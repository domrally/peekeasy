...
export const composeState: <S, T extends symbol>(Base: new (...args: any[]) => S & { state: State<T>, onEnter?(): void, onExit?(): void }) => new (...args: any[]) => S & AsyncIterable<T> = (window as any).composeState
